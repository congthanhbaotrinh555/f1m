$(document).ready(function() {
	...
	$('#second-step-button').click(function() {
		if ($('#account-username').val() != '') {
			...
			swal("Error", "Please enter your PlayerID.", "error");
		}
	});
